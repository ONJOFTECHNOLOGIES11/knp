...
<body>
    ...
    <heading class="voters_heading">
        <center><h1>Registered Governor Candidates</h1>
           <center>
                <select onchange = "page(this.value)">
                <option disabled selected>Select Candidate Group</option>
                <option value = "pres.php">President</option>
                <option value = "vp.php">CS Finance</option>
                <option value = "ua.php">Secretary General</option>
                <option value = "ss.php">Woman Representative</option>
                <option disabled selected>Governor </option>
