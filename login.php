                    ...
                    <div class="form-panel"><center>
                        ...
                        <form role="form" method = "post" enctype = "multipart/form-data" class="index-form">
                            ...
                            <center>Student Login</center>
                             ...
                             <br/>
                                <center><button class="btn btn-lg  btn-block " name = "login" style= " margin-bottom:0px; background-color:maroon; color: orange;" width="50">Login</button>
                                &nbsp; 
                            <a  href="register/index.php"><button type="button" class="btn btn-lg  btn-block" data-dismiss="modal" style= " margin-bottom:0px;background-color:maroon; color: orange;">Register</button></a>
